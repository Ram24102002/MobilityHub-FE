    ...
    <div className="min-h-screen  bg-[#F5F1E8] py-16 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-62 h-full bg-gradient-to-r from-orange-50 to-transparent pointer-events-none z-10"></div>
          <div className="absolute top-0 right-0 w-62 h-full bg-gradient-to-l from-orange-50 to-transparent pointer-events-none z-10"></div>
        </div>
      </div>
    </div>
  );
